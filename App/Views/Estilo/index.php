...
<script src="/javascript/Estilo/Estilo.js"></script>
...
//<div class="divCheck"><label for="outroTamsBlusas">Outro: </label><input type="text" name="outroTamsBlusas" id="outroTamsBlusas"/></div>
echo '<div class="tituloLongo">Qual Tamanho de Calça/Saia/Short você costuma usar?</div>
...
Dê uma nota de 1 a 5 para esse estilo baseado no quanto você gosta dele (Esportivo / Natural): <span class="pointObrigatorio">*</span>
<div class="scaleInput">';
for ($i=1; $i <= 5 ; $i++) { 
    echo '
    <div class="chooseNumber"><label for="Natural-'.$i.'">
        <div class="scaleNumber">'.$i.'</div>
        <div><input type="radio" name="notaNatural" id="Natural-'.$i.'" value="'.$i.'"';
        if($dadosEstilo['notaNatural'] == $i){echo ' checked';}
        echo '/></div>
    </label></div>
    ';
}
